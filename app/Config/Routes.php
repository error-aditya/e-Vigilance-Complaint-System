...
$routes->get('sign-up2', 'Home::signup2');
...
$routes->get('addemp2', 'Home::addemp2');
$routes->post('store_officer', 'Home::store_officer');
$routes->post('store_employee2', 'Home::store_employee2');
...
$routes->get('addhwd','Home::addhwd');
$routes->post('stspdate', 'Home::stspdate');
$routes->post('store_hwd', 'Home::store_hwd');
$routes->get('viewcomplaint', 'Home::viewcomplaint');
$routes->get('assignhwd', 'Home::assignhwd');
$routes->post('store_assign_hwd', 'Home::store_assign_hwd');
$routes->post('store_complaint', 'Home::store_complaint');
$routes->get('view_Assign_Hwd', 'Home::view_Assign_Hwd');
$routes->get('update_hwd/(:num)', 'Home::update_hwd/$1');
$routes->post('update_hardware', 'Home::update_hardware');
$routes->post('delete_hardware', 'Home::delete_hardware');
