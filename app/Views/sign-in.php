...
<html lang="en">
	<head><base href="../../../">
		...
		<link rel="shortcut icon" href="<?php echo base_url('assets/media/logos/1.png');?> "/>
	...
	<body id="kt_body" class="bg-body">
		<div class="d-flex flex-column flex-root">
			<div id="backimg" class="d-flex flex-colum flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(<?php echo base_url('assets/media/illustrations/sketchy-1/newp.png');?>)">
		...
		<form class="form w-100" novalidate="novalidate" method="post" name="kt_sign_in_form" 
						...
						<div class="text-center mb-10">
								...
								<a href="<?php echo base_url('sign-up');?>" class="link-primary fw-bolder">Login</a></div>
						</div>
		...
		<div class="d-flex flex-center flex-column-auto p-100">
			<div class="d-flex align-items-center fw-bold fs-6">
				<a href="http://localhost/Project\E-vigilance\app\views\about.html" class="text-muted text-hover-primary px-2">About</a>
