...
<html lang="en">
	...
	<body id="kt_body" class="bg-body">
		<div class="d-flex flex-column flex-root">
			<div class="d-flex flex-colum flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(<?php echo base_url('assets/media/illustrations/sketchy-1/14.png');?>)">
		...
		<form class="form w-100" novalidate="novalidate" method="post" name="kt_sign_in_form" 
						...
						<div class="text-center mb-10">
								...
								<a href="<?php echo base_url('sign-up2');?>" class="link-primary fw-bolder">Sign-up</a></div>
						</div>
