...
<div class="d-flex flex-column flex-root">
    <div id="bimg"class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(<?php echo base_url('assets/media/illustrations/sketchy-1/newp.png');?>)">		
	<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
		<a href="../../demo4/dist/index.html" class="mb-12">
		<img class="lgg" alt="Logo" src="<?php echo base_url('assets/media/logos/1.png');?> "  /><span class="lg"><b>e-Vigilance Complaint System<b></span>
        </a>
